...
public final class Song {
    ...
    /**
     * สร้างเพลง 
     * @param title ห้าม null/ว่าง
     * @param artist ห้าม null/ว่าง
     * @param tags ห้าม null/ว่าง   และห้ามมีสมาชิกเป็น null/ว่าง
     * @throws IllegalArgumentException เมื่อผิดเงื่อนไข มี null
     */
    ...
    public Song withTag(String tag) {
        ...
        if (tags.contains(null)) throw new IllegalArgumentException() ;

        List<String> new_tag = new ArrayList<>(tags);
        new_tag.add(tag);

        checkRep();
        return new Song(title, artist, new_tag);
    }
